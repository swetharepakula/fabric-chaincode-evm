...
func (fake *MockStub) GetPrivateDataHashCallCount() int {
...
func (fake *MockStub) GetPrivateDataHashArgsForCall(i int) (string, string) {
	fake.getPrivateDataHashMutex.RLock()
	defer fake.getPrivateDataHashMutex.RUnlock()
...
func (fake *MockStub) GetPrivateDataHashReturns(result1 []byte, result2 error) {
...
func (fake *MockStub) GetPrivateDataHashReturnsOnCall(i int, result1 []byte, result2 error) {
	fake.GetPrivateDataHashStub = nil
